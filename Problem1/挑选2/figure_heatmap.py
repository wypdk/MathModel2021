...
df_ads = pd.read_excel('./挑选2.xlsx',header=None)
...
plt.savefig("./挑选2-热力图.png",dpi=600)
...
df_ads = pd.read_excel('./挑选2.xlsx',sheet_name="3",header=None)
...
plt.tight_layout()
plt.title("Spearman rank Correlation Coefficient MAttrix Heatmap")
plt.savefig("./挑选3-热力图.png",dpi=600)
